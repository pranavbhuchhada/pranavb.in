...
const LayoutWrapper = ({ children }) => {
  ...
  return (
    <>
      ...
      <header className="overflow-x-hidden backdrop-blur supports-backdrop-blur:bg-white/75 py-6 sticky top-0 z-40 bg-white/75 dark:bg-dark/75">
        <div className="mx-auto flex items-center justify-between px-6">
          <div>
            <Link href="/" aria-label="Pranav's Blog">
              <div className="flex items-center justify-between">
                <div className='sm:block text-2xl font-semibold'>
                  {siteMetadata.author}
                </div>
              </div>
            </Link>
